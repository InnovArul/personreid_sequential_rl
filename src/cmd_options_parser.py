...
def stage2_parse_cmd_options():
    ...
    parser.add_argument('--test-batch', default=1, type=int, help="has to be 1") 
    parser.add_argument('--num-train-iterations', default=10000, type=int, help="train iterations") 
    parser.add_argument('--num-test-iterations', default=1000, type=int, help="train iterations") 
